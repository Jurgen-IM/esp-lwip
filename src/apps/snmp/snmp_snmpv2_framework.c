...
const struct snmp_obj_id usmHMACSHA256AuthProtocol 	= { 10, { 1, 3, 6, 1, 6, 3, 10, 1, 1, 5 } };
const struct snmp_obj_id usmHMACSHA512AuthProtocol 	= { 10, { 1, 3, 6, 1, 6, 3, 10, 1, 1, 7 } };	
/* .4 sha-224
 * .5 sha-256
 * .6 sha-384
 * .7 sha-512
...
const struct snmp_obj_id usmAES192PrivProtocol = 	{ 10, { 1, 3, 6, 1, 6, 3, 10, 1, 2, 5 } };
const struct snmp_obj_id usmAES256PrivProtocol =	{ 10, { 1, 3, 6, 1, 6, 3, 10, 1, 2, 6 } };
/* .7 unknown
 */

/* TODO: where should this value come from? */
#define SNMP_FRAMEWORKMIB_SNMPENGINEMAXMESSAGESIZE (SNMP_MESSAGE_MAX_SIZE)
